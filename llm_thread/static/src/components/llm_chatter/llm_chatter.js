                    ...
                    <div class="p-3 border-bottom bg-warning-subtle">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="text-dark"><strong>LLM Header Component Unavailable</strong></span>
                                <small class="text-muted d-block">
                                    Provider and model selection features are not available. 
                                    Chat functionality will use default settings.
                                </small>
                            </div>
                            <button class="btn btn-sm btn-outline-secondary" onclick="document.querySelector('.o-mail-Chatter-aiButton').click()">
                                <i class="fa fa-times"></i>
